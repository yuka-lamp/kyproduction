...
<div class="img-wrap"><img src="<?php echo $wp_url; ?>/lib/images/aroma/intro_img.png" alt="頑張りが反映される給与システム"></div>
</div>
</section>
<section id="welfare" class="bg-color flex">
<div class="content">
<div class="sec txt-c">
<img class="mb-1" src="<?php echo $wp_url; ?>/lib/images/aroma/lamp.svg" alt="ランプのアイコン"><h3 class="fff">未経験でも大丈夫</h3>
<p class="ipad-txt-c fff">アットホームな雰囲気の中マンツーマンでの親切丁寧な研修があります。<br>実力あるセラピストや、オーナーが指導します。</p>
</div>
</div>
<div class="content">
<div class="sec txt-c">
<img class="mb-1" src="<?php echo $wp_url; ?>/lib/images/aroma/graf.svg" alt="レベルアップのアイコン"><h3 class="fff">経験者の方はさらにレベルアップ</h3>
